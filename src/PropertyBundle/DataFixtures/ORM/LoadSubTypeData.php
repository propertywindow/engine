...
class LoadSubTypeData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference('sub_type_cottage', $subType);
        ...
        $this->addReference('sub_type_detached_bungalow', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_detached_house', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_end_terraced_house', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_house_others', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_house_with_land_over_one_acre', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_linked_bungalow', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_mews_house', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_semi_detached_bungalow', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_semi_detached_house', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_terraced_bungalow', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_terraced_house', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_townhouse', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Cottage');
        $this->addReference('sub_type_basement_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_double_upper_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_duplex', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_fifth_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Maisonnette');
        $this->addReference('sub_type_first_and_ground_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_first_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_flat_others', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Cottage');
        $this->addReference('sub_type_fourth_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Cottage');
        $this->addReference('sub_type_garden_and_ground_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Cottage');
        $this->addReference('sub_type_garden_flat', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Cottage');
        $this->addReference('sub_type_ground_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Cottage');
        $this->addReference('sub_type_lower_flat', $subType);
        $manager->persist($subType);
        ...
        $subType->setNl('Cottage');
        $this->addReference('sub_type_lower_ground_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_lower_villa', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_maindoor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_maisonette_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_mews_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_penthouse_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_second_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_sixth_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_studio_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_third_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_top_floor_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_triplex', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_upper_flat', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_upper_villa', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_commercial', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_lock_ups_and_car_parking', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_new_build', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_retirement', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_single_house_plot', $subType);
        $manager->persist($subType);
        ...
        $this->addReference('sub_type_timeshare', $subType);
        $manager->persist($subType);
