 ...
 * @ORM\Entity(repositoryClass="ClientBundle\Repository\SurveysRepository")
...
class Surveys
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AgentBundle\Entity\Surveyor")
    ...
    /**
     * @param \AgentBundle\Entity\Surveyor $surveyor
     *
     * @return Surveys
     */
    ...
    /**
     * @return \AgentBundle\Entity\Surveyor
     */
